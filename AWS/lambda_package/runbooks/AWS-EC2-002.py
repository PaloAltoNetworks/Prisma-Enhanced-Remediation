...
AWS:EC2-002 Global Admin Port Access - SSH (TCP Port 22) Detected

Description:

Global permission to access the well-known services TCP port 22 (SSH) should not be allowed in a
security group.
